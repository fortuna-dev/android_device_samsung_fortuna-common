...
static void configure_governor()
{
    ...
    if (strncmp(governor, "ondemand", 8) == 0) {
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay", "25000");
        sysfs_write("/sys/devices/system/cpu/cpufreq/interactive/timer_rate", "25000");
    }
}
